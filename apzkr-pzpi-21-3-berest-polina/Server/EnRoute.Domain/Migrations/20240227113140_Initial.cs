...
namespace EnRoute.Domain.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CounterInstallationRequests",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    CellWithTempControlCount = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CounterInstallationRequests", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NeedsCooling = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PickupCounters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PickupCounters_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    hasTemperatureControl = table.Column<bool>(type: "bit", nullable: false),
                    CounterId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CellOpenKey = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cells", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Cells_PickupCounters_CounterId",
                        column: x => x.CounterId,
                        principalTable: "PickupCounters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "CounterDeinstallationRequests",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RequestedTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CounterDeinstallationRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CounterDeinstallationRequests_PickupCounters_CounterId",
                        column: x => x.CounterId,
                        principalTable: "PickupCounters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedCellId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Orders_Cells_AssignedCellId",
                        column: x => x.AssignedCellId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TechInspectionRequests_Cells_CellId",
                        column: x => x.CellId,
                        principalTable: "Cells",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cells_CounterId",
                table: "Cells",
                column: "CounterId");

            migrationBuilder.CreateIndex(
                name: "IX_CounterDeinstallationRequests_CounterId",
                table: "CounterDeinstallationRequests",
                column: "CounterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PickupCounters_OrganizationId",
                table: "PickupCounters",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_TechInspectionRequests_CellId",
